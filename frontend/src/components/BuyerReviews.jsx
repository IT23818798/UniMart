...
import { FaEdit, FaRedo, FaSearch, FaStar, FaTrashAlt } from 'react-icons/fa';
              ...
              <div key={review.reviewId} className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
                <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                  <div className="flex gap-4">
                    ...
                    />
                    <div>
                      <h3 className="text-lg font-bold text-gray-900">{review.productTitle}</h3>
                      <p className="text-sm text-gray-600">
                        Seller: <span className="font-semibold">{review.sellerName || 'Unknown Seller'}</span>
                      </p>
                      <p className="text-xs uppercase tracking-wide text-gray-500">{review.productCategory}</p>
                ...
                {!isEditing ? (
                  <>
                    ...
                    <p className="mt-3 rounded-lg bg-gray-50 p-3 text-sm text-gray-700">{review.comment}</p>
                  </>
                ) : (
